  ...
  <body>
    ...
    <section class="signupbox">
      <div class="signup_container">
        ...
        <form class="" action="<?php echo base_url().'index.php/Auth/register_restaurant'; ?>" method="post" name="signup_form">
          ...
          <div id="bottom">
            ...
            <a href="<?php echo base_url().'index.php/Auth/register_customer'; ?>">&nbspSignUp as Customer</a>
          </div>
        </form>
      </div>
    </section>
